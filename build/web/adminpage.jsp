...
<li><a href="userD.jsp">View User List</a></li>
...
Services @:<br><select name="ser" id="loc" style="background: yellow; height: 28px;  width:250px;">
    <option>Music</option>
...
Description:<br>
<input type="text" name="des" id="des" style="background: yellow; height: 88px;  width:250px;"><br><br>
Recommend Site:<br>
<input type="text" name="rec" id="rec" style="background: yellow; height: 28px;  width:250px;"><br><br>
