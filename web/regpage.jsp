          ...
          <div class="col-3">
            <div class="indent">
              ...
              <form action="regaction.jsp" name="ff"  method="get" onsubmit="return check()">
                    Name: <br><input type="text" name="name" id="name" style="background: yellow; height: 28px;  width:250px;"><br><br>
                    User Id: <br><input type="text" name="user" id="user" style="background:  yellow; height: 28px;  width:250px;"><br><br>
                    Password: <br><input type="password" name="pass" id="pass" style="background:  yellow; height: 28px;  width:250px;"><br><br>
                    Email Id:<br> <input type="email" name="email" id="mail" style="background:  yellow; height: 28px;  width:250px;"><br><br>
                    Date of Birth:<br> <input type="date" name="dob" id="dob" style="background:  yellow; height: 28px;  width:250px;"><br><br>
                        
                    Interest:<br><select name="loc" id="loc" style="background: yellow; height: 28px;  width:250px;">
     <option>Music</option>
    <option>Sports</option>
    <option>Cooking</option>
    <option>Cooking & Sports</option>
     <option>Cooking & Music</option>
      <option>Music & Sports</option>
     
     </select> <br>
                 
                    Gender:<br><select name ="sex" id="sex" style="background:  yellow; height: 28px;  width:180px;"><option>Male</option>     
